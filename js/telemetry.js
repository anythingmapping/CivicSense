...
var bertrudeMarker = L.marker([-40.331000, 175.661500]).addTo(mymap).bindPopup("<h3 id='sensor1' class='text-center'> Bertrude</h3><img src='img/alan.png' width=200px >");
...
for (var i = 0; i < sensorLength; i++) {
    ...
    var sensors = L.marker([-40.331846, 175.661509]).addTo(mymap).bindPopup("<h3 id='sensor1' class='text-center'> Bertrude</h3><img src='img/alan.png' width=200px >");
};
